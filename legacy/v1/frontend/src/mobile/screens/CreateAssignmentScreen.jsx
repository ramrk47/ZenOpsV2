...
import { Chip, MobileListSkeleton, Section, StickyFooter } from '../components/Primitives'
...
export default function CreateAssignmentScreen() {
  ...
  return (
    ...
    >
      ...
      {step === 2 ? (
        <Section title="Land Inputs" subtitle="Policy-driven land mode">
          <div className="m-chip-row">
      ...
      {step === 3 ? (
        <Section title="Final Details" subtitle="Minimal fields for draft save">
          <div className="m-form-grid">
            <label>
              <span>Phone</span>
