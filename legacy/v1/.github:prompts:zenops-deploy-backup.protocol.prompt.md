---
agent: "agent"
description: "Implement Maulya safe update protocol + backups + Google Drive offsite via rclone"
---

## Mission
Implement a production-safe update protocol for Maulya on a single VPS/KVM using Docker Compose:
...
- default remote path: `gdrive:MaulyaBackups/<env>/`
