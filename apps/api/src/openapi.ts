...
const document = {
  ...
  paths: {
    ...
    '/v1/control/tenant': {
      get: { summary: 'Control-plane billing accounts list', responses: { '200': { description: 'OK' } } }
    },
    '/v1/control/accounts': {
      post: { summary: 'Create or upsert billing account', responses: { '200': { description: 'OK' } } }
    },
    '/v1/control/accounts/{id}/status': {
      get: { summary: 'Get control-plane billing account status', responses: { '200': { description: 'OK' } } },
      patch: { summary: 'Set account status ACTIVE or SUSPENDED', responses: { '200': { description: 'OK' } } }
    },
    '/v1/control/accounts/{id}/policy': {
      patch: { summary: 'Set account billing policy (POSTPAID or CREDIT)', responses: { '200': { description: 'OK' } } }
    },
    '/v1/control/accounts/{id}/credits/grant': {
    ...
    '/v1/control/credits/tenant/{tenantId}': {
      get: { summary: 'Tenant-level credit aggregate and account rollup', responses: { '200': { description: 'OK' } } }
    },
    '/v1/control/credits/reservations': {
      get: { summary: 'List credit reservations for account/tenant', responses: { '200': { description: 'OK' } } }
    },
    '/v1/control/credits/timeline': {
      get: { summary: 'Combined billing timeline feed', responses: { '200': { description: 'OK' } } }
    },
    '/v1/control/credits/reserve': {
      post: { summary: 'Studio reserve credits', responses: { '200': { description: 'OK' } } }
    },
    '/v1/control/credits/consume': {
      post: { summary: 'Studio consume reserved credits', responses: { '200': { description: 'OK' } } }
    },
    ...
    '/v1/attendance/checkout': {
      post: { summary: 'Record employee check-out', responses: { '200': { description: 'OK' } } }
    },
    '/v1/payroll/periods': {
      get: { summary: 'List payroll periods', responses: { '200': { description: 'OK' } } },
      post: { summary: 'Create payroll period', responses: { '201': { description: 'Created' } } }
    },
    '/v1/payroll/periods/{id}/run': {
      post: { summary: 'Run payroll period (placeholder)', responses: { '200': { description: 'OK' } } }
    },
    '/v1/payroll/periods/{id}/items': {
      get: { summary: 'List payroll items', responses: { '200': { description: 'OK' } } },
      post: { summary: 'Create payroll item', responses: { '201': { description: 'Created' } } }
    },
    '/v1/notifications/routes': {
      get: { summary: 'List notification route targets', responses: { '200': { description: 'OK' } } },
      post: { summary: 'Create or update notification route target', responses: { '200': { description: 'OK' } } }
    },
    '/v1/work-orders': {
    ...
    '/v1/assignments/{id}/assignees/{user_id}': {
      delete: { summary: 'Remove assignment assignee', responses: { '200': { description: 'OK' } } }
    },
    '/v1/assignments/{id}/tasks': {
      get: { summary: 'List assignment tasks', responses: { '200': { description: 'OK' } } },
      post: { summary: 'Create assignment task', responses: { '200': { description: 'OK' } } }
    },
    ...
    '/v1/assignments/{id}/activities': {
      get: { summary: 'List assignment activities', responses: { '200': { description: 'OK' } } }
    },
    '/v1/assignments/{id}/attach-document': {
      post: { summary: 'Attach existing document to assignment', responses: { '200': { description: 'OK' } } }
    },
    '/v1/report-requests': {
    ...
    '/v1/billing/invoices/{id}': {
      get: { summary: 'Get invoice detail with lines and payments', responses: { '200': { description: 'OK' } } }
    },
    ...
    '/v1/files/confirm-upload': {
      post: { summary: 'Confirm upload and attach links', responses: { '200': { description: 'OK' } } }
    },
    '/v1/files/{id}/presign-download': {
      get: { summary: 'Presign document download', responses: { '200': { description: 'OK' } } }
    },
    '/v1/documents': {
      get: { summary: 'List documents with filters', responses: { '200': { description: 'OK' } } }
    },
    '/v1/documents/{id}/metadata': {
      patch: { summary: 'Patch document metadata', responses: { '200': { description: 'OK' } } }
    },
    '/v1/documents/{id}/tags': {
      post: { summary: 'Upsert document tags', responses: { '200': { description: 'OK' } } }
    },
    '/v1/repogen/work-orders': {
      get: { summary: 'List Repogen work orders', responses: { '200': { description: 'OK' } } },
      post: { summary: 'Create Repogen work order', responses: { '201': { description: 'Created' } } }
    },
    '/v1/repogen/work-orders/{id}': {
      get: { summary: 'Get Repogen work order detail', responses: { '200': { description: 'OK' } } }
    },
    '/v1/repogen/work-orders/{id}/contract': {
      patch: { summary: 'Patch Repogen contract and persist computed snapshot', responses: { '200': { description: 'OK' } } }
    },
    '/v1/repogen/work-orders/{id}/evidence/link': {
      post: { summary: 'Link evidence items to Repogen work order', responses: { '200': { description: 'OK' } } }
    },
    '/v1/repogen/work-orders/{id}/evidence-profiles': {
      get: { summary: 'List/selectable Repogen evidence profiles for work order', responses: { '200': { description: 'OK' } } }
    },
    '/v1/repogen/work-orders/{id}/evidence-profile': {
      post: { summary: 'Select Repogen evidence profile for work order', responses: { '200': { description: 'OK' } } }
    },
    '/v1/repogen/work-orders/{id}/field-evidence-links': {
      get: { summary: 'List field-to-evidence links for Repogen work order', responses: { '200': { description: 'OK' } } },
      post: { summary: 'Upsert field-to-evidence links for Repogen work order', responses: { '200': { description: 'OK' } } }
    },
    '/v1/repogen/work-orders/{id}/ocr/enqueue': {
      post: { summary: 'Enqueue Repogen OCR placeholder job for an evidence item', responses: { '200': { description: 'OK' } } }
    },
    '/v1/repogen/work-orders/{id}/export': {
      get: { summary: 'Export deterministic Repogen snapshot JSON bundle', responses: { '200': { description: 'OK' } } }
    },
    ...
    '/v1/report-requests/{id}/data-bundle': {
      get: { summary: 'Get report data bundle', responses: { '200': { description: 'OK' } } },
      patch: { summary: 'Patch report data bundle', responses: { '200': { description: 'OK' } } }
    },
